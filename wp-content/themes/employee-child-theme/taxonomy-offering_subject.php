   		...
   		<section class="content page">
	   		...
	   		<h1>District Offerings : <?php single_cat_title(); ?></h1>
	   			<?php
					...
					$args = array( 'post_type' => 'develop_offerings', 'tax_query' => array(array('taxonomy' => 'offering_subject','field' => 'slug', 'terms' => $single_category)) ,'posts_per_page' => -1 , 'meta_key' => 'event_date', 'orderby' => 'meta_value_num', 'order' => 'ASC','meta_query' => array( array( 'key' => 'event_date', 'value' => $today, 'compare' => '>' )));
							...
							while ($the_query->have_posts()) : $the_query->the_post();?>
								<article class="pd-offering">
						   			<div class="offering-content">
							   			...
							   			<h2><?php the_title(); ?></h2>
								   			<?php
										   			$terms = get_the_terms( $post->ID , 'offering_subject' ); 
								                    foreach ( $terms as $term ) {
								                        $term_link = get_term_link( $term, 'Offering Subjects' );
