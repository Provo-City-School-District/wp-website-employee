   ...
   <main id="mainContent">
   		<section class="content page">
	   		...
	   		<h1>District Offerings : <?php single_cat_title(); ?></h1>
				...
				//	if($single_category !== 'Endorsements') {}
					$args = array( 'post_type' => 'develop_offerings', 'tax_query' => array(array('taxonomy' => 'offering_type','field' => 'slug', 'terms' => $single_category)) ,'posts_per_page' => -1 , 'meta_key' => 'event_date', 'orderby' => 'meta_value_num', 'order' => 'ASC','meta_query' => array( array( 'key' => 'event_date', 'value' => $today, 'compare' => '>' )));
					
					 /* else {
						$args = array( 'post_type' => 'develop_offerings', 'tax_query' => array(array('taxonomy' => 'offering_type','field'    => 'slug', 'terms' => $single_category)) ,'posts_per_page' => -1 , 'meta_key' => 'event_date', 'orderby' => 'meta_value_num', 'order' => 'ASC');	
					}	*/				
